<template>
  <div class="content">
    ...
    <h1><img src="../assets/img/login.png"/></h1>
    <div class="login-box">
      <p class="lsolid"></p>
      <div class="login">
    ...
    <div class="footbox">
      <uc-button @click="reg" style="margin-top:.23rem" bgColor="red">注 册</uc-button>
      <a href="javascript:;" class="tishi">已有账号？</a>
    </div>
  </div>
...
<style scoped>
  ...
  .content h1{width:2.18rem;height:1.35rem; margin:0 auto; margin-top:1rem;}
  .content h1 img{width: 2rem;}
