<template>
  <div id="content">
    <div id="header">
      ...
      <div class="user-box">
        <a class="us">用户:{{$route.query.user.nikename}}</a>
        <a @click="logout" class="change">切换用户</a>
      </div>
    </div>
    <div class="docList">
      <ul>
...
<style scoped>
   .us{display: block;margin: 0 auto;width: 1.3rem;}
  .change{position: absolute;top:0.2rem;right: 0.1rem;}
  ...
  #header .user-box{ font-size:0.25rem; color:#fff; margin:0 auto; margin-top:0.2rem;}
